...
export default function LoginScreen() {
  ...
  return (
    <div className="min-h-svh w-full bg-[#F0F4F2] text-emerald-950 flex justify-center items-start font-sans relative overflow-hidden px-3 py-4 sm:items-center sm:py-6">
      <div className="absolute top-[-8rem] left-[-8rem] w-72 h-72 bg-emerald-300/35 rounded-full mix-blend-multiply blur-[70px] animate-blob sm:w-96 sm:h-96" />
      <div className="absolute top-[10rem] right-[-7rem] w-64 h-64 bg-emerald-300/35 rounded-full mix-blend-multiply blur-[70px] animate-blob animation-delay-2000 sm:w-72 sm:h-72" />
      <div className="absolute bottom-[-8rem] left-[10%] w-64 h-64 bg-emerald-200/40 rounded-full mix-blend-multiply blur-[70px] animate-blob animation-delay-4000 sm:w-80 sm:h-80" />
      ...
      <div className="w-full max-w-[26rem] flex flex-col relative z-10">
          ...
          <header className="flex justify-between items-center mb-7 relative z-10 sm:mb-10">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[10px] text-emerald-200 font-medium mt-1 tracking-widest uppercase">
                  Dashboard Aplikasi
                </p>
              </div>
            </div>
        ...
        <div className="flex-grow px-3 flex flex-col -mt-12 relative z-20 sm:px-6 sm:-mt-16">
          <section className="rounded-[1.75rem] bg-white p-5 shadow-2xl shadow-emerald-900/10 border border-white/50 backdrop-blur-xl mb-5 sm:rounded-[2rem] sm:p-6 sm:mb-8">
            <div className="flex items-center gap-3 mb-5 sm:mb-6">
              ...
              <div>
                ...
                <p className="text-[11px] text-emerald-700/60 font-medium">
            ...
            {error && (
              <div className="mb-5 p-4 bg-red-50 text-red-600 text-xs font-bold rounded-xl border border-red-100 text-center">
                {error}
              </div>
            )}
            ...
            >
              <span className="bg-white p-1.5 rounded-lg group-hover:rotate-12 transition-transform">
                <Image
          ...
          <section className="mt-2 mb-4 sm:mt-4 sm:mb-6">
            <p className="text-[10px] text-center text-emerald-800/40 font-bold uppercase tracking-[0.2em] mb-3 sm:mb-4">
              Didukung Oleh
            </p>
            <div className="flex items-center justify-center gap-4 bg-white/60 backdrop-blur-sm rounded-3xl py-3 px-4 border border-white/40 shadow-sm sm:gap-6 sm:py-4 sm:px-6">
              <Image
                ...
                width={48}
                height={48}
                className="h-7 w-auto object-contain hover:scale-110 transition-transform sm:h-8"
                priority
              />
              <Image
                src="/logosea.webp"
